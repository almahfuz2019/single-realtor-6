...
export default function HeroSection() {
  return (
    <div className="relative py-12 md:py-24 bg-primary 2xl:h-screen">
      {/* Main container */}
      <section className="max-w-[1420px] mx-auto container px-4 sm:px-8 md:px-16">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-12">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-[#88A9C3] font-bold text-3xl md:text-5xl leading-9 md:leading-[60px] font-merriweather">
              Live the dream, Start your <br /> next chapter
            </h1>
            <p className="text-[#88A9C3CC] font-normal text-lg md:text-2xl mt-6 md:mt-10 font-raleway">
              Begin your journey of home, transform your story into a successful
              chapter with our expert real estate guidance.
            </p>
            {/* Buttons */}
            <div className="mt-6 md:mt-10 flex flex-col sm:flex-row gap-3 md:gap-8 justify-center lg:justify-start w-full font-roboto">
              <a
                href="#"
      ...
      {/* Social media links */}
      <div className="absolute top-1/2 right-0 transform -translate-y-1/2 flex flex-col space-y-2 md:space-y-4 mr-2 md:mr-6">
        <Image
