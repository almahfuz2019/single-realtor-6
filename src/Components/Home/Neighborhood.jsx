...
export default function Neighborhood() {
  ...
  return (
    <div className="bg-primary p-12 sm:p-24">
      <section className="container mx-auto">
        {/* Header section with title and description */}
        <header className="grid grid-cols-2 gap-8 items-center mb-12">
          <div data-aos="fade-right">
            <h1 className="text-5xl font-merriweather text-[#88A9C3]">
              Neighborhood
            </h1>
            <p className="text-2xl text-[#88A9C3CC] font-raleway mt-3">
          ...
          <div className="flex justify-end" data-aos="fade-left">
            <button className="bg-neutral px-6 py-3 rounded-lg text-primary font-medium text-2xl font-roboto">
              Explore
            </button>
          </div>
        </header>
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6 lg:p-8">
                  <div className="text-center opacity-0 transition-opacity group-hover:opacity-100">
                    <p className="text-4xl text-neutral font-raleway font-semibold">
                      {city.name}
                    </p>
                  </div>
                </div>
