...
const insightsData = [
  {
    ...
    imageUrl: "/Images/blog1_Thumbnail.webp",
    link: "#",
  },
  {
      ...
      <div className="max-w-screen-xl mx-auto mb-10 md:mb-20  px-4 sm:px-8 lg:px-8 2xl:px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 justify-between items-end">
          ...
          <div className="flex justify-end" data-aos="fade-left">
            <button className="mt-2 md:mt-8 bg-primary px-4 md:px-5 py-2 md:py-2.5  rounded-lg text-neutral font-medium text-base md:text-xl font-roboto transition-all duration-300 ease-in-out hover:bg-neutral hover:text-primary hover:shadow-lg ">
              See all
            </button>
          </div>
        </div>
